...
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTC_04 //软件IIC  CLK脚选择
#define TCFG_SW_I2C0_DAT_PORT               IO_PORTC_05                            //软件IIC  DAT脚选择
#define TCFG_SW_I2C0_DELAY_CNT              1                                      //IIC延时参数，影响通讯时钟频率
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   DISABLE_THIS_MOUDL//ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE //是否使能AD按键
...
#endif //CONFIG_BOARD_AC6951D_KEYBOARD
#endif //CONFIG_BOARD_AC6951D_KEYBOARD_CFG_H
