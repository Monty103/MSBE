...
#define TCFG_UART0_RX_PORT					IO_PORTB_01                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				IO_PORTB_00                            //串口发送脚配置
#define TCFG_UART0_BAUDRATE  				1000000                                //串口波特率配置
#define TCFG_UART0_IRQ                      IRQ_UART0_IDX
...
#define TCFG_VIR_UDISK_ENABLE               1//ENABLE_THIS_MOUDLE
...
#define TCFG_TOUCH_KEY_CHANGE_GAIN 			2 	//变化放大倍数, 一般固定
...
//key0配置
#define TCFG_TOUCH_KEY0_PORT 				IO_PORTA_09 //触摸按键IO配置
#define TCFG_TOUCH_KEY0_VALUE 				1 		 	 //触摸按键key0 按键值

//key1配置
#define TCFG_TOUCH_KEY1_PORT 				IO_PORTA_10 //触摸按键key1 IO配置
...
//                                  时钟配置                                       //
//*********************************************************************************//
#define TCFG_CLOCK_SYS_SRC					/*SYS_CLOCK_INPUT_PLL_RCL*/ SYS_CLOCK_INPUT_PLL_BT_OSC   //系统时钟源选择
...
#define TCFG_IIS_INPUT_DATAPORT_SEL          1
...
#if ((TCFG_ONLINE_TX_PORT == IO_PORT_DP) && TCFG_ONLINE_ENABLE && TCFG_EQ_ONLINE_ENABLE) && (TCFG_PC_ENABLE || TCFG_UDISK_ENABLE)
