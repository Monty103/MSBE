...
static u8 ep1_dma_tx_buffer[64]  __attribute__((aligned(4)))SEC(.usb_hid_dma);
//static u8 ep1_dma_tx_buffer[32]  __attribute__((aligned(4)))SEC(.usb_hid_dma);

static u8 ep2_dma_tx_buffer[64]  __attribute__((aligned(4)))SEC(.usb_cdc_dma);
static u8 ep2_dma_rx_buffer[64]  __attribute__((aligned(4)))SEC(.usb_cdc_dma);

static u8 ep3_dma_tx_buffer[64]   __attribute__((aligned(4)))SEC(.usb_iso_dma);
//static u8 ep3_dma_tx_buffer[32]   __attribute__((aligned(4)))SEC(.usb_iso_dma);

static u8 ep4_dma_tx_buffer[64]  __attribute__((aligned(4)))SEC(.usb_hid_dma);
//static u8 ep4_dma_tx_buffer[32]  __attribute__((aligned(4)))SEC(.usb_hid_dma);
...
void *usb_get_ep_buffer(const usb_dev usb_id, u32 ep)
{
    ...
    if (ep & USB_DIR_IN) {
        ...
        case 1:
            ...
            ep_buffer = ep1_dma_tx_buffer;

            break;
        case 2:
            ep_buffer = ep2_dma_tx_buffer;
            break;
        case 3:
            ep_buffer = ep3_dma_tx_buffer;
            break;
        case 4:
            ep_buffer = ep4_dma_tx_buffer;
            //ep_buffer = NULL;
            break;
        }
    } else {
        ...
        case 0:
            ...
            break;
        case 1:
            ep_buffer = ep1_dma_tx_buffer+32;
            break;
        case 2:
            ep_buffer = ep2_dma_rx_buffer;
            break;
        case 3:
            ep_buffer = ep3_dma_tx_buffer+32;
            break;
        case 4:
            ep_buffer = ep4_dma_tx_buffer+32;
            break;
        }
    }
    return ep_buffer;
